...
public abstract class InstancedRewindAbstract : MonoBehaviour
{
    ...
    /// </summary>
    protected virtual void RestorePositionAndRotation(float seconds)
    {
    ...
    /// </summary>
    protected virtual void RestoreVelocity(float seconds)
    {   
        if(body!=null)
        {
